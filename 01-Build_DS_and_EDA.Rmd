...
ggplot(data=CCMDs, aes(x = Population))+
  ...
  coord_flip()
```
<br> Four clusters are immediately evident (low pop/low sales, med pop/low sales, high pop/low sales, and high pop/high sales). Cluster analysis will need to be performed.
