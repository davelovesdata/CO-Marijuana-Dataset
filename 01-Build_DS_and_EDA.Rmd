...
#interesting failure... I need to disect this.
ggplot(data=CCMDs_scale, aes(x = Population, color=cluster))+
  geom_point(shape=25, aes(y = Rec_Sales/100000), show.legend = TRUE, size = 1.25)+
  ...
  coord_flip()
```
<br> The clusters didn't line up exactly as I expected but were grossly right. I think next I should try the same exercise with Principal Component Analysis (PCA). I'm interested in the eigenvector values.
