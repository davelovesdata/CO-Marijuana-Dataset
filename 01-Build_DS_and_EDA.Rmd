...
View(CCMDs_f1)
CCMDs_f1 <- CCMDs_f1[order(CCMDs_f1$Population),]

ggplot(data=CCMDs_f1, aes(x=as.factor(Year)))+
  geom_boxplot(aes(y=Rec_Sales), color="green", show.legend=TRUE)+
  geom_boxplot(aes(y=Med_Sales), color="red", show.legend=TRUE)+
  labs(title="Aggregate Colorado Retail and Medical Marijuana Sales since 2014 by County", x= "Colorado County", y= "Sales")+
  theme_bw()+
