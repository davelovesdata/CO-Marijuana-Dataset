...
library(NbClust)
nb <- NbClust(CCMDs_scale, diss=NULL, distance="euclidean", min.nc=2, max.nc = 15, method="kmeans", index="all", alphaBeale = 0.1)
...
#ggplot(data=CCMDs, aes(x = Population, color=cluster))+
#  geom_point(aes(y = Rec_Sales/100000 + Med_Sales/100000), show.legend = TRUE, size = 1.25)+
#  stat_ellipse(aes(y = Rec_Sales/100000 + Med_Sales/100000))+
#  theme_bw()+
#  coord_flip()
```
